...
public class cart {
    ...
    public HashMap<Integer, Integer> productCount = new HashMap<>();
    ...
    public void removeItemByPID(int pid) {
        item Item = getItemByItemID(pid);
        Integer counter = productCount.get(Item.getItemID()) != null ? productCount.get(Item.getItemID()) - 1 : null;
        productCount.put(Item.getItemID(), counter);
    }
